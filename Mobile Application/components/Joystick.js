  ...
  return (
    <View style={[styles.joystick, { backgroundColor: theme.background }]}>
      <TouchableOpacity
        ...
        activeOpacity={0.7}
      >
        <MaterialIcons name="keyboard-arrow-up" size={50} color={theme.primary} />
      </TouchableOpacity>
      <View style={styles.horizontalButtons}>
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <MaterialIcons name="keyboard-arrow-left" size={50} color={theme.primary} />
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.button, { backgroundColor: theme.surface }]}
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <MaterialIcons name="keyboard-arrow-right" size={50} color={theme.primary} />
        </TouchableOpacity>
      </View>
      <TouchableOpacity
        style={[styles.button1, { backgroundColor: theme.surface }]}
        ...
        activeOpacity={0.7}
      >
        <MaterialIcons name="keyboard-arrow-down" size={50} color={theme.primary} />
      </TouchableOpacity>
    </View>
  );
};