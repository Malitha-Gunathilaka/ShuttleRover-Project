      ...
      >
        <View style={styles.modalContainer}>
          <View style={[styles.modalContent, { backgroundColor: theme.background }]}>
            <Text style={[styles.modalTitle, { color: theme.primary }]}>User Manual</Text>
            <ScrollView style={styles.scrollView}>
              <Text style={[styles.modalText, { color: theme.text }]}>
                
                <Text style={[styles.modalsubTitle, { color: theme.text}]}>How to control the robot:</Text>
                ...
                {"\n\n"}<Text style={[styles.modalsubTitle, { color: theme.text}]}>Button Functions:</Text>
                </Text>
              <Image
              ...
              <Text style={[styles.modalText, { color: theme.text }]}>
                ...
                {"\n\n"}<Text style={[styles.modalsubTitle, { color: theme.text}]}>Additional Information:</Text>
                {"\n"}- Ensure the robot is fully charged before use.
                {"\n"}- Keep the robot within the designated area to avoid obstacles.
                {"\n"}- Regularly check for software updates to ensure optimal performance.
                {"\n\n"}<Text style={[styles.modalsubTitle, { color: theme.text}]}>Safety Precautions:</Text>
                {"\n"}- Do not operate the robot near water or flammable materials.
                {"\n"}- Keep hands and clothing away from moving parts.
                {"\n"}- Supervise children when they are using the robot.
                {"\n\n"}<Text style={[styles.modalsubTitle, { color: theme.text}]}>Troubleshooting Tips:</Text>
                {"\n"}- If the robot is not responding, check the battery level.
                {"\n"}- Ensure the robot is within range of the controller.
                {"\n"}- Restart the robot and controller if they are not connecting.
                {"\n\n"}<Text style={[styles.modalsubTitle, { color: theme.text}]}>Maintenance Guidelines:</Text>
